...
export const metadata: Metadata = { title: "Catalogo maniglie — UFPtrade" };

/**
 * Reparto maniglie. Il titolo è «Catalogo» e non «Archivio»: nel reparto
 ...
 * guardando. Vedi `sidebar.tsx` per perché non è più «Disponibilità».
 */
export default function ManigliePage() {
  return (
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-4">
      <h1 className="text-xl font-semibold text-ink">Catalogo</h1>
      <Suspense
